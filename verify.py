...
def verify_version(
    ...
    dispatches = [
        ...
        (0x3D60, "CustomType1Main"),
        (0x3F74, "CustomType3Main"),
        (0x4324, "CustomType4Main"),
    ]
    ...
    allowed_ranges = [
        ...
        interval(0x2CD64, 4), interval(0x3D60, 4),
        ...
        interval(0x2CCD0, 4), interval(0x4324, 4), interval(JEALOUSY_RECORD, 0x2C),
